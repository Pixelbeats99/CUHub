...
CREATE TABLE `uservideos` (
  ...
  KEY `userID` (`userID`),
  KEY `videoID` (`videoID`),
  CONSTRAINT `uservideos_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`),
  CONSTRAINT `uservideos_ibfk_2` FOREIGN KEY (`videoID`) REFERENCES `videos` (`videoID`)
...
-- Dump completed on 2019-03-16 12:28:20
